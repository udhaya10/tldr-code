...
- [x] **Step 2: Run the focused test and verify the missing registry fails**
...
- [x] **Step 3: Implement the registry and orphan-protocol checks**
...
- [x] **Step 4: Run the route-contract test**
...
- [x] **Step 4: Remove or classify stale protocol variants**
...
- [x] **Step 5: Validate daemon lifecycle**
...
- [x] **Step 1: Write failing snapshot-index tests**
...
- [x] **Step 3: Add a source-independent BM25 constructor**
...
- [x] **Step 4: Add the resident manager**
...
- [x] **Step 5: Validate construction and freshness**
...
- [x] **Step 1: Write failing typed-search parity tests**
...
- [x] **Step 3: Replace the stale daemon Search command**
...
- [x] **Step 5: Wire hybrid retrieval**
...
- [x] **Step 6: Run search parity and repeated-query tests**
...
- [x] **Step 1: Add failing daemon-versus-oneshot tests**
...
- [x] **Step 2: Add missing projections**
...
- [x] **Step 3: Add typed daemon commands**
...
- [x] **Step 4: Split mixed commands at the correct boundary**
...
- [x] **Step 5: Run differential and freshness tests**
...
- [x] **Step 1: Classify every zero-production-caller API**
...
- [x] **Step 3: Run CodeRabbit over the implementation diff**
...
- [x] **Step 4: Benchmark Dhan repeated queries**
...
- [x] **Step 5: Close Beads only from evidence**
...
Completed 2026-07-29 in `ef76581` and `7d21dab`.

- One daemon implementation and executable protocol/command ownership
  registries are enforced by integration tests.
- CLI and MCP share generation-pinned resident lexical and semantic routes.
- Workspace references, global definition, deps, and project coupling use
  ArtifactStore projections; bounded local modes remain explicitly local.
- Legacy cold/fallback/JSON cache APIs and the duplicate daemon package are
  removed.
- Freshness tests cover edits, deletes, renames, ignore-policy changes,
  generation mismatch, and unaffected-language BM25 reuse.
- Core/CLI unit tests, workspace all-feature tests, workspace strict clippy,
  workspace check, and formatting passed.
- The first CodeRabbit pass found blocking-pool, hybrid-language, and delta
  refresh defects; those findings were fixed. A second pass remained
  non-terminal and produced no additional findings within its bounded window.
- The installed release and clean Dhan rebuild are documented in
  `docs/benchmarks/2026-07-29-dhan-authoritative-runtime/REPORT.md`.
